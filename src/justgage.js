...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#FFFFFF"),
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#FFFFFF"),
    ...
    gaugeColor: kvLookup('gaugeColor', config, dataset, ""),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#FFFFFF", "#FFFFFF", "#FFFFFF"], 'array', ','),
